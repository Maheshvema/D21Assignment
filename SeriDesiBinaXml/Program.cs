...
//            Stream stream = new FileStream(@"C:\Users\Sai Yaswanth\OneDrive\Desktop\simplilearn\Day-21 Assignment\SeriDesiBinaXml\SeriDesiBinaXml\EmployeeData.txt", FileMode.Create, FileAccess.Write);
//            formatter.Serialize(stream, Emp);
//            stream.Close();
//            stream = new FileStream(@"C:\Users\Sai Yaswanth\OneDrive\Desktop\simplilearn\Day-21 Assignment\SeriDesiBinaXml\SeriDesiBinaXml\EmployeeData.txt", FileMode.Open, FileAccess.Read);
